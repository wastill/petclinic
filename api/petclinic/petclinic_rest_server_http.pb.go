...
func RegisterPetClinicRestServiceHTTPServer(s *http.Server, srv PetClinicRestServiceHTTPServer) {
	...
	r.GET("/petclinic/owner/{owner_id}/pet", _PetClinicRestService_GetOwnerPet0_HTTP_Handler(srv))
	r.PUT("/petclinic/user/{username}", _PetClinicRestService_UpdateUser0_HTTP_Handler(srv))
	r.GET("/petclinic/owner/{username}", _PetClinicRestService_GetUser0_HTTP_Handler(srv))
	r.GET("/petclinic/users", _PetClinicRestService_ListUser0_HTTP_Handler(srv))
	r.POST("/petclinic/auth/register", _PetClinicRestService_Register0_HTTP_Handler(srv))
	r.POST("/petclinic/auth/login", _PetClinicRestService_Login0_HTTP_Handler(srv))
	r.GET("/petclinic/auth/current_user", _PetClinicRestService_CurrentUser0_HTTP_Handler(srv))
}
...
func _PetClinicRestService_UpdateUser0_HTTP_Handler(srv PetClinicRestServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, OperationPetClinicRestServiceUpdateUser)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PetClinicRestService_GetUser0_HTTP_Handler(srv PetClinicRestServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, OperationPetClinicRestServiceGetUser)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PetClinicRestService_ListUser0_HTTP_Handler(srv PetClinicRestServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in ListUserRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, OperationPetClinicRestServiceListUser)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PetClinicRestService_Register0_HTTP_Handler(srv PetClinicRestServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, OperationPetClinicRestServiceRegister)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PetClinicRestService_Login0_HTTP_Handler(srv PetClinicRestServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in LoginRequest
		if err := ctx.Bind(&in); err != nil {
			return err
		...
		http.SetOperation(ctx, OperationPetClinicRestServiceLogin)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PetClinicRestService_CurrentUser0_HTTP_Handler(srv PetClinicRestServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in GetCurrentUserRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, OperationPetClinicRestServiceCurrentUser)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.CurrentUser(ctx, req.(*GetCurrentUserRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
func (c *PetClinicRestServiceHTTPClientImpl) CurrentUser(ctx context.Context, in *GetCurrentUserRequest, opts ...http.CallOption) (*GetCurrentUserReply, error) {
	var out GetCurrentUserReply
	pattern := "/petclinic/auth/current_user"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationPetClinicRestServiceCurrentUser))
	opts = append(opts, http.PathTemplate(pattern))
...
func (c *PetClinicRestServiceHTTPClientImpl) GetUser(ctx context.Context, in *GetUserRequest, opts ...http.CallOption) (*GetUserReply, error) {
	var out GetUserReply
	pattern := "/petclinic/owner/{username}"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationPetClinicRestServiceGetUser))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *PetClinicRestServiceHTTPClientImpl) ListUser(ctx context.Context, in *ListUserRequest, opts ...http.CallOption) (*ListUserReply, error) {
	var out ListUserReply
	pattern := "/petclinic/users"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationPetClinicRestServiceListUser))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *PetClinicRestServiceHTTPClientImpl) Login(ctx context.Context, in *LoginRequest, opts ...http.CallOption) (*LoginReply, error) {
	var out LoginReply
	pattern := "/petclinic/auth/login"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationPetClinicRestServiceLogin))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *PetClinicRestServiceHTTPClientImpl) Register(ctx context.Context, in *CreateUserRequest, opts ...http.CallOption) (*CreateUserReply, error) {
	var out CreateUserReply
	pattern := "/petclinic/auth/register"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationPetClinicRestServiceRegister))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *PetClinicRestServiceHTTPClientImpl) UpdateUser(ctx context.Context, in *UpdateUserRequest, opts ...http.CallOption) (*UpdateUserReply, error) {
	var out UpdateUserReply
	pattern := "/petclinic/user/{username}"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationPetClinicRestServiceUpdateUser))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "PUT", path, in, &out, opts...)
	if err != nil {
		return nil, err
